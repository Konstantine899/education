...
# 40. Функции parseInt(), parseFloat() и Number() 
...
# 42. Объект Math и его методы round(), ceil(), floor()
...
# 43. Объект Match и его метод random()
...
В предыдущем уроке мы с вами выводили методами
![](../img/394.png)
...
# 46. Функции setTimeout(), setInterval(), clerInterval()
...
# 51. Создание методов для собственного объекта
...
# 52. Вывод на экран всех свойств объекта и их значений
...
# 53. Объекты navigator, screen, location и их свойства 
...
#57. Выбор элементов методом getElementsByTagName()
...
# 58. Выбор элемента методом getElementByld()
...
![](../img/558.png)
На самом деле у нас между тегом div и первой картинкой есть пробелы. А мы знаем что пробел для JavaScript ни чем не отличается например от буквы а, и по сути для него такая ситуация, пробел для него все равно какой то символ. по этому вот здесь у нас получилась такая ситуация что мы увидили эти значения undefined потому что когда мы запросили все дочерние узлы для этого блока div то он нам туда положил не только картинки но и эти пробельные символы которые находятся между ними. Если мы возьмем и соединим все в единую строку то вывода undefined не будет. Вот такая особенность JavaScript что он считает пробелы за текстовые узлы.
