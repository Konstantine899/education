* [1. Методы write() обьект document](#методы-write()-обьект-document) 
* [2. Отлов ошибок и коментарии](#отлов-ошибок-и-коментарии)
* [3. Суть и создание переменных](#суть-и-создание-переменных)
* [4. Использвание переменных](#использвание-переменных) 
* [5. Какие имена можно давать переменным](#какие-имена-можно-давать-переменным)
...
![](./img/438.png)
  ...
  Ставим двоеточие и пишем что нужно делать. В нашем случае что мы выиграли авто. И при этом после кода нужно указать ключевое слово 
  break;
